    ...
    <?php elseif( get_row_layout() == 'three_columns' ): ?>
                                ...
                                <?php if( have_rows('repeater') ): while( have_rows('repeater') ): the_row(); ?>
                                    <a class="link-box " href="<?php the_sub_field('link'); ?>">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <img class="icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-arrow-right-white.svg" alt="">
                                        </div>
                                    </a>
                                <?php endwhile; endif; ?>
                            </div>
        ...
        <div class="wrapper has-background slick-slider-hero-wrapper full-height aos">
            ...
            <a class="hero-link" href="#nextSection"  title="Go To Next Section">
                <img class="hero-arrow" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-arrow-right-blue.svg" alt="Arrow to next section">
            </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center aos aos--slide-up">
                        <a href="#" data-toggle="modal" data-target="#id<?php echo $id; ?>">
                            <?php $image=get_sub_field( 'image'); if( !empty($image) ): ?>
                                <img class="fullsize" src="<?php echo $image['sizes']['thumbnail']; ?>" alt="<?php echo $name; ?>" />
                            <?php endif; ?>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-body text-center">
                                    <?php $image=get_sub_field( 'image'); if( !empty($image) ): ?>
                                        <img class="modal-image" src="<?php echo $image['sizes']['thumbnail']; ?>" alt="<?php echo $name; ?>" />
                                    <?php endif; ?>
                                    <p class="name"><?php echo $name; ?></p>
                            <p class="job"><?php echo $job; ?></p>
                                    <p><?php echo $bio; ?></p>
        ...
        <?php elseif( get_row_layout() == 'case_studies' ): 
            ...
            <div class="wrapper aos">
                <div class="container flex">
                    ...
                    <a class="link" href="/case-studies/">View all case studies <img class="icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-arrow-right-blue.svg" alt="">
                                        </a>
                    ...
                    <div class="row icon-box-wrapper">
                        ...
                        <div class="icon-box aos aos--slide-up">
                            <div class="col-12 col-lg-4">
                                <?php $image=get_sub_field( 'image'); if( !empty($image) ): ?><img class="marginbottomsm" src="<?php echo $image['sizes']['medium']; ?>" /><?php endif; ?>
                            </div>
                        ...
                        <?php $term = get_sub_field('project_section'); $args=array( 'post_type'=> 'projects', 'posts_per_page' => 100, 'orderby' => 'date', 'tax_query' => array( array(
                             ...
                             <a class="blog-feed-link " href="<?php the_permalink(); ?>" title="<?php the_field('location'); ?> - <?php the_field('lift_type'); ?>">
                                <?php if(get_the_post_thumbnail()){
                                        ...
                                        <img class="thumbnail" src="<?php echo esc_url( get_theme_mod( 'hsd_projects_img' ) ); ?>">
                                    <?php 
                                    } ?>
                                    <div class="blog-feed-link-text ">
                                        <h2><?php the_title(); ?></h2>
                                        <p class="small-text"><?php the_field('lift_type'); ?></p>
                                        <span class="link">View case studies <img class="icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-arrow-right-blue.svg" alt=""></span>
                                    </div>
                                </a>
